...
TS = util.Enum(
    ...
    "PARSE_TOO_COMPLEX",
    "PARSE_NOT_IN_LOOP",
    "PARSE_CLASS_ARG0_NOT_SELF",
    "PARSE_MIXED_RETURNS",
    "PARSE_CLASS_ALL_STATEMENTS_IN_FUNCTIONS",
    "PARSE_CLASS_NO_BASES_ALLOWED",
    "PARSE_CONST_NOT_INT",
    "OPT_START",
    "OPT_RESERVED_NAME",
    "OPT_INCORRECT_ARG_USE",
    "OPT_INCORRECT_ARG_DEFINE",
    "OPT_VAR_NOT_BOUND",
    "OPT_VAR_NOT_INT",
    "OPT_VAR_TYPE_CHANGED",
    "OPT_STRING_NOT_ALLOWED",
    "OPT_LIST_NOT_ALLOWED",
    "OPT_CLASS_INIT_ERROR",
    "OPT_CLASS_DATA_ERROR",
    "OPT_NOT_CLASS_REF",
    "OPT_NOT_ASSIGNABLE",
    "OPT_SLICE_NOT_ALLOWED",
    "OPT_LCL_HIDES_GLB",
    "OPT_NOT_A_GLOBAL_VAR",
    "OPT_WRITE_TO_ED_PY_CONSTANT",
    "OPT_FUNCTION_NOT_DEFINED",
    "OPT_NOT_SUPPORTED",
    "OPT_VAR_MUST_BE_TS_OR_LIST",
    "OPT_ONLY_AT_TOP_LEVEL",
    "OPT_SELF_NOT_IN_METHOD",
    "OPT_UNKNOWN_FUNCTION",
    "OPT_UNKNOWN_ED_FUNCTION",
    "OPT_MISSING_ED_IMPORT",
    "OPT_CONSTANT_TOO_NEGATIVE",
    "OPT_CONSTANT_TOO_POSITIVE",
    "OPT_ED_ASSIGN_NOT_CONSTANT",
    "OPT_ED_ASSIGN_AGAIN",
    "OPT_ED_ASSIGN_BAD_VALUE",
    "OPT_ED_ASSIGN_NOT_SET",
    "OPT_ED_ASSIGN_IN_FUNCTION",
    "OPT_ED_FUNCTION_NOT_AVAILABLE",
    "OPT_ED_FUNCTION_NOT_USEFUL",
    "OPT_ED_WARN_TUNESTRING_END",
    "OPT_ED_LIST_TOO_LONG",
    "OPT_BAD_EVENT_NUMBER",
    "CMP_START",
    "CMP_INTERNAL_ERROR",
    "CMP_VAR_NOT_BOUND",
    "ASM_START",
...
class OutClass(object):
    ...
    def __Out(self, outputLevel, stringNumber, rawText, args):
        ...
        if len(potentials) > 0:
            ...
            while len(found):
                if posCount not in found:
                    self.FatalRaw(
                        "TransString positional arguments are not contiguous."
                    )
        ...
        if posCount != len(args):
            self.FatalRaw(
                "TransString pos count {0} doesn't match the number of args {1}".format(
                    posCount, len(args)
                )
            )
    ...
    def DebugDumpObjectRaw(self, obj, name=""):
        ...
        if (self.maxOutputLevel >= LEVEL.DEBUG) and (
            ...
            for d in dir_data:
                if (d in ("__module__", "__doc__")) or (not d.startswith("__")):
