...
movw $1 %_cpu:acc
brz :_Control_0_else
# CALL:<program.Call name:waitClap with args:[]>
stinc $2
suba ::_fun_waitClap
stdec $2
...
stdec $2
# CALL:<program.Call name:Ed.TimeWait with args:[<program.Value const:100>, <program.Value const:1>]>
stinc $3
movw $100 %_cpu:acc
stwaw $0
movw $1 %_cpu:acc
...
stwaw $3
stdec $3
# BAssign:<program.BAssign <program.Value name:TEMP-1> = <program.Value name:TEMP-0> Eq <program.Value const:4>>
straw $0
cmpw $4
brne :_int_0000
movw $1 %_cpu:acc
...
stdec $2
# CALL:<program.Call name:Ed.Drive_CM with args:[<program.Value const:1>, <program.Value const:10>, <program.Value const:15>]>
stinc $6
movw $1 %_cpu:acc
stwaw $0
movw $10 %_cpu:acc
...
bra :_Control_1_end
:_Control_1_else
# CALL:<program.Call name:Ed.Drive_CM with args:[<program.Value const:7>, <program.Value const:10>, <program.Value const:90>]>
stinc $6
movw $7 %_cpu:acc
stwaw $0
movw $10 %_cpu:acc
...
# LOOP_CTRL:<program.LoopControl 2, name:While, test:<program.Value name:TEMP-1>>
...
# CTRL_MARKER:<program.ControlMarker marker:8 While start>
:_Control_8_start
...
# LOOP_CTRL:<program.LoopControl 8, name:While, test:<program.Value name:TEMP-0>>
...
:_Control_10_else
:_Control_10_end
# CTRL_MARKER:<program.ControlMarker marker:8 While end>
bra :_Control_8_start
:_Control_8_else
:_Control_8_end
ret
...
# OPTIMISED OUT (STACK_READ): straw $9
stwaw $8
# CTRL_MARKER:<program.ControlMarker marker:64 If else>
bra :_Control_64_end
:_Control_64_else
...
:_Control_66_start
# LOOP_CTRL:<program.LoopControl 66, name:If, test:<program.Value name:left>>
straw $6
...
:_Control_67_start
# LOOP_CTRL:<program.LoopControl 67, name:If, test:<program.Value name:right>>
straw $7
...
# OPTIMISED OUT (STACK_READ): straw $5
stwaw $3
# CTRL_MARKER:<program.ControlMarker marker:85 If start>
:_Control_85_start
# LOOP_CTRL:<program.LoopControl 85, name:If, test:<program.Value name:data>>
straw $3
brz :_Control_85_else
...
bitclr 2 %60
# CTRL_MARKER:<program.ControlMarker marker:85 If end>
:_Control_85_else
:_Control_85_end
