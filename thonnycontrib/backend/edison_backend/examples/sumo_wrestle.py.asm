...
# Set intial tempo
movw $250 %68
# Ed.RegisterEventHandler:<program.Call name:Ed.RegisterEventHandler with args:[<program.Value const:7>, <program.Value const:"detectForward">]>
# Ed.RegisterEventHandler:<program.Call name:Ed.RegisterEventHandler with args:[<program.Value const:5>, <program.Value const:"detectLeft">]>
# Ed.RegisterEventHandler:<program.Call name:Ed.RegisterEventHandler with args:[<program.Value const:6>, <program.Value const:"detectRight">]>
...
:_Control_1_else
:_Control_1_end
# CALL:<program.Call name:Ed.Drive_CM with args:[<program.Value const:2>, <program.Value const:5>, <program.Value const:4>]>
stinc $6
movw $2 %_cpu:acc
stwaw $0
movw $5 %_cpu:acc
...
# Inline function for Ed.Drive_INLINE_UNLIMITED:<program.Call name:Ed.Drive_INLINE_UNLIMITED with args:[<program.Value const:1>, <program.Value const:10>, <program.Value const:0>]>
movb $138 %81
movb $138 %31
ret
:_end_detectForward
...
stdec $2
# CALL:<program.Call name:Ed.Drive_CM with args:[<program.Value const:5>, <program.Value const:10>, <program.Value const:30>]>
stinc $6
movw $5 %_cpu:acc
stwaw $0
movw $10 %_cpu:acc
...
stdec $2
# CALL:<program.Call name:Ed.Drive_CM with args:[<program.Value const:3>, <program.Value const:10>, <program.Value const:30>]>
stinc $6
movw $3 %_cpu:acc
stwaw $0
movw $10 %_cpu:acc
...
stop
END MAIN
BEGIN EVENT %IR_RECEIVER1:status, 16, 16
bitclr $4 %IR_RECEIVER1:status
pushw @_CALC
suba ::_fun_detectForward
popw @_CALC
stop
END EVENT
BEGIN EVENT %IR_RECEIVER1:status, 32, 32
bitclr $5 %IR_RECEIVER1:status
pushw @_CALC
suba ::_fun_detectLeft
popw @_CALC
stop
END EVENT
BEGIN EVENT %IR_RECEIVER1:status, 8, 8
bitclr $3 %IR_RECEIVER1:status
pushw @_CALC
suba ::_fun_detectRight
popw @_CALC
stop
END EVENT
FINISH
