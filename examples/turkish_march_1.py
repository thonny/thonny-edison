...
def playTone(length, tone):
    ...
    Ed.WriteModuleRegister16Bit(
        Ed.MODULE_BEEPER, Ed.REG_BEEP_FREQ_16, tones[tone + TRANSPOSITION]
    )
    ...
    Ed.WriteModuleRegister16Bit(
        Ed.MODULE_BEEPER, Ed.REG_BEEP_DURATION_16, (length & 127) * 7 + 1
    )
...
while repeat < 2:
    ...
    Ed.WriteModuleRegister8Bit(
        Ed.MODULE_LEFT_LED, Ed.REG_LED_OUTPUT_8, 0
    )  # compensation of some unexplained unsync
